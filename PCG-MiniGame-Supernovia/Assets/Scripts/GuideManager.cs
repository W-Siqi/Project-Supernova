...
//        yield return ViewManager.instance.ViewCardsOnScreen(StoryContext.instance.gameStatecharacterDeck.ToArray());
...
//        StoryContext.instance.gameStatestatusVector.money -= 40;
//        yield return new WaitForSeconds(5f);
...
//        var voters = StoryContext.instance.gameStatecharacterDeck.ToArray();
